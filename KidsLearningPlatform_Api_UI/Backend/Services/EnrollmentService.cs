...
public class EnrollmentService : IEnrollmentService
{
    ...
    {
        var existing = (await _repo.GetByKidId(dto.KidId)).FirstOrDefault(e =>
    ...
    public Task<int> CountEnrollmentsByDateRange(DateTime start, DateTime end) =>
        _repo.CountEnrollmentsByDateRange(start, end);

    public Task<int> CountKidsByCourseAndGrade(int courseId, string grade) =>
        _repo.CountKidsByCourseAndGrade(courseId, grade);
}
