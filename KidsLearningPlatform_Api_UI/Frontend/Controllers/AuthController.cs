...
namespace Frontend.Controllers
{
  public class AuthController : Controller
  {
    ...
    [HttpPost]
    public async Task<IActionResult> Register(string userName, string email, string password, string role = "Parent")
    {
      var apiUrl = _config["ApiBaseUrl"] + "/Token/register";
      var regData = new { UserName = userName, Email = email, Password = password, Role = role };
