...
class Program
{
    static void Main()
    {
        Employee emp1 = new Employee("Anu", "FullTime");
        Employee emp2 = new Employee("Banu", "PartTime");
        Employee emp3 = new Employee("Charu", "Freelancer");
        Intern emp4 = new Intern("Dinesh");
